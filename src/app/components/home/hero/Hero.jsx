...
const Hero = () => {
  ...
  const socialIcon = [
    ...
    { icon: <FaWhatsapp size={28} />, link: "https://wa.me/+918830528553" },
  ];
  const textVariants = {
        ...
        >
          ...
          >
            ...
            <h1 className="sm:text-5xl text-5xl lg:text-6xl xl:text-7xl font-semibold">
              I am <span className="name"> Mayur</span>
            </h1>
            ...
            >
              ...
              <a href="https://drive.google.com/file/d/1VwMT-yMGmAtL3VZVVe0SKgvAmx2suZsB/view">
          ...
          >
            <Image
              ...
              height={1080}
              width={1080}
              className="lg:w-[500px] w-full object-cover h-[400px] lg:h-[500px] rounded-xl"
            />
          </motion.div>
        </motion.div>
      </Wrapper>
